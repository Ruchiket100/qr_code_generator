    ...
    return (
        <div className='w-screen h-screen bg-gradient-to-r from-purple-200 to-white'>
            <div className='w-full md:w-[60%] h-full flex flex-col gap-10 md:gap-12 md:items-center justify-center m-auto px-2'>
                <h1 className='text-5xl md:text-8xl font-extrabold bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text  md:text-center tracking-tighter'>GENERATE CUSTOMIZED QR CODES</h1>
                <div>
